...
public class PresenceController {
	...
	public Response welcomeFile(RequestToFunc r, Response resp, Etat etat) {
		try {
			resp.setBody(Tools.fileToString("Ressources/"+"home.html"));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
	...
	public Response fillPresence(RequestToFunc r, Response resp, Etat etat) {
		...
		resp.putCookie("login", etat.getPropriete("login"));
		try {
	...
	public Response displayProfile(RequestToFunc r, Response resp, Etat etat){
		...
		map.put("login", etat.getPropriete("login"));
		map.put("mail", etat.getPropriete("mail"));
		try {
	...
	public Response modifyPresence(RequestToFunc r, Response resp, Etat etat){
		resp.setBody(MyTools.modifyPresence(r.getQuery("login").trim()));
		resp.putContentType("text/plain");
		return resp;
	}
